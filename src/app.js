    ...
    render(){
        ...
        return (
            <div>
                ...
                <div>
                    <button onClick={this.handleClickDisplay.bind(this,"all")}>Show All</button>
                    <button onClick={this.handleClickDisplay.bind(this,"complete")}>Completed</button>
                    <button onClick={this.handleClickDisplay.bind(this,"active")}>Not Completed</button>
                </div>
            </div>
        );
    }
